...
//   - Ship_ReacquireSquadLeader 0x004156a0 (squad-leader death succession)
//   - the Frame_TickSystems 0x004186b0 scope-6 squad-flag pass that gates the
...
//     transfers ships attached to the player (squad_leader_ship_slot == 0) into
...
// resolved_squad_leader_ship_slot equals leader.ship_instance_id, assigns the
...
// to the player (squad_leader_ship_slot == 0) is adopted into the player's
