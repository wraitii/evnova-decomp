...
NovaLanded_OpenOutfitterSession(const GameState &state, std::int16_t stellar_id);
[[nodiscard]] LandedStoreSession
NovaLanded_OpenShipyardSession(const GameState &state, std::int16_t stellar_id);

[[nodiscard]] std::int32_t NovaLanded_ScaledStorePrice(std::int32_t base_price,
...
[[nodiscard]] bool NovaLanded_CanBuyShip(const GameState &state,
                                         std::int16_t stellar_id,
                                         std::int16_t ship_id);
[[nodiscard]] bool NovaLanded_ReplacePlayerShip(GameState &state,
                                                 std::int16_t stellar_id,
                                                 std::int16_t ship_id,
