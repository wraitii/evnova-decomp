...
// mission Visit/Return overrides, and government policy flag 1.
[[nodiscard]] bool NovaTravel_PlayerMeetsStellarAccess(const GameState &state,
...
// player's reputation/outfit/hazard/mission/government state admits it, the
