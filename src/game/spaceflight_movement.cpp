...
// DIVERGENCE(original): the 0x168-entry angle lookup tables are approximated
// with sin/cos (project-wide radian heading representation).
...
// DIVERGENCE(original): radian heading uses sin/cos rather than the original
// integer-degree angle lookup tables (project-wide representation).
